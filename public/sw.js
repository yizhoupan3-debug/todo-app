const CACHE_VERSION = 'v43'; // Bump on each deploy
...
const STATIC_ASSETS = [
    ...
    '/js/utils.js?v=43',
    '/js/app.js?v=43',
    '/js/app-theme.js?v=43',
    '/js/app-persona-nav.js?v=43',
    '/js/app-coins.js?v=43',
    '/js/widget-installer.js?v=43',
    '/js/api.js?v=43',
    '/js/ambient.js?v=43',
    '/js/views/daily.js?v=43',
    '/js/views/monthly.js?v=43',
    '/js/views/checkin.js?v=43',
    '/js/views/stats.js?v=43',
    '/js/views/garden.js?v=43',
    '/js/views/garden-island.js?v=43',
    '/js/views/garden-shop.js?v=43',
    '/js/components/task-modal.js?v=43',
    '/js/components/ics-import.js?v=43',
    '/js/components/pomodoro.js?v=43',
    '/manifest.json',
    '/img/panpan.png',
    '/img/pupu.png',
    '/img/all.png',
